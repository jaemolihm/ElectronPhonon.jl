...
@testset "transport with screening" begin
    ...
    σ_serta_reference = Dict(:Lindhard => 0.13989211028360177, :RPA => 0.13444720985278077)
    σ_reference = Dict(:Lindhard => 0.07411494913216994, :RPA => 0.07106564977717034)
    ...
    for method in [:Lindhard, :RPA]
        ...
        if method == :RPA
            @test screening_params_rpa.μ ≈ transport_params.μlist[1]
        end
